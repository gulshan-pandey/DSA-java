...
class Kar {
    ...
    final int MARKS = 99; // now this final keyword means that the variable has became constant and cant be changed now,the convention of writing the variable of final keyword is by making them "CAPITAL_AND_ADDED_BY_THESE_DASHES"
...
public class ToString {
    public static void main(String[] args) {
        ...
        // so what if we define our own toString mthod it will just imply our toString
        // method
