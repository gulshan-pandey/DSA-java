...
public class Exercises {
        ...
        public static void main(String[] args) {
                ...
                List<String> lis = new ArrayList<>(
                                List.of("dog", "cow", "monkey", "goat", "deer", "donkey", "lion", "tiger", "leopard",
                                                "cat", "rabbit"));   // this is a modifiable list
                ...
                //WAP to find the sum of the numbers greater than 5 in the list-----------------------------
                ...
                //Integer val = l.stream().filter(li -> li > 5).reduce(0, Integer::sum);    // method 2
                System.out.println("\n the sum of the numbers greater than 5 is : " + val);
    ...
    // List<Men> sortedlist = menwage.stream().sorted((a,b) -> b.getSal() - a.getSal()).collect(Collectors.toList());
    // System.out.println(sortedlist);         // method 2
