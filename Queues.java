...
public class Queues {
    ...
    public static void main(String[] args) {
        ...
        CollectionUtility.print(queue); //calling the utility class which will print all the elements

        System.out.println(queue.peek());  // the head of the queue is 1 because 1 entered earliest  ( fist in first out)
        System.out.println(queue.element());  // peek and element both used to view the head element but  element could give Exception and peek cannot
