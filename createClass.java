...
class Swordigo{
    ...
    public void run(){
        System.out.println("RUnning aray from the enemy");
    }
}
...
public class CreateClass {
    ...
    Student gulshan = new Student(); //Instantiating a new Student object
    ...
    // System.out.println(gulshan.id);
    // System.out.println(gulshan.name);
    gulshan.details();
    john.details();
