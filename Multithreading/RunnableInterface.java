...
public class RunnableInterface {
    public static void main(String[] args) {
        ...
        // Thread gun1 = new Thread(bullet1,"Name1");  //this is necessary
        // Thread gun2 = new Thread(bullet2,"Name2"); // this is the official thread class which is to be objectified and take our implemented object as input in it then kicked to start
