class RunnThread implements Runnable {
    ...
    public void run() {
        for (int i = 0; i < 40; i++) {
            System.out.println("here is winter");
        }
    }
}
...
public class RunnableInterface {
    public static void main(String[] args) {
        ...
        Thread gun2 = new Thread(bullet2,"bc2"); //i think this is the official thread class which is to be objectified and take our implemented object as input in it then kicked to start
