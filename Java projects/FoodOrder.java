class Customer {
	...
	private static float deliveryCharge; //static variable initialized
	static {
		deliveryCharge = 1.5f;
	}
	public Customer(String customerId, String customerName, long contactNumber, String address) {   //constructor
