...
//Question calculate the avg marks from an array containg marks of all staudents in physics using forEach loop
...
// int a = Math.floor(5.2) => is 5.0  //this returnes the float greatest value of any number

// in b =Math.floorDiv(5,2)=> is 2  it is similar to Math.floor but it gives the int value
